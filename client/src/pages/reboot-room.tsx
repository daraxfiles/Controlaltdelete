    ...
    <main className="pt-24 min-h-screen bg-background">
      <div className="container mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="text-[hsl(var(--muted-foreground))] max-w-xl mb-12 leading-relaxed">
          Selected youth projects, open to the public. Read the work. Add your expertise. Commit to action. Every verified response is added to the patch's public record.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[hsl(var(--muted-foreground))] leading-relaxed">
                All audience responses are moderated by a facilitator before being added to the public record. Responses that contain harmful content, personal attacks, or unverified claims will not be published. Youth profiles are private by default.
              </p>
            </div>
          </div>
        </div>
